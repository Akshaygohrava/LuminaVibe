...
![LuminaVibe Social Media App](src/assets/Github-Images/LuminaVibe-LandingPage.png)
  ...
  <table width="100%">
    <tr>
      <td width="50%" align="center">
        ...
        <br/>
        <img src="src/assets/Github-Images/LuminaVibe-LandingPage.png" width="100%" alt="LuminaVibe Landing Page"/>
      </td>
      <td width="50%" align="center">
        <b>🌒 Dark Mode Feed</b>
        <br/>
        <img src="src/assets/Github-Images/LuminaVibe-DarkMode.png" width="100%" alt="LuminaVibe Dark Mode Feed"/>
      </td>
    </tr>
    <tr>
      <td width="50%" align="center">
        ...
        <br/>
        <img src="src/assets/Github-Images/LuminaVibe-UserProfile.png" width="100%" alt="LuminaVibe User Profile"/>
      </td>
      <td width="50%" align="center">
        <b>💬 Interactive Direct Messaging</b>
        <br/>
        <img src="src/assets/Github-Images/LuminaVibe-UserMessage.png" width="100%" alt="LuminaVibe Messaging"/>
      </td>
    </tr>
    <tr>
      <td width="50%" align="center">
        ...
        <br/>
        <img src="src/assets/Github-Images/LuminaVibe-UserSearch.png" width="100%" alt="LuminaVibe Search"/>
      </td>
      <td width="50%" align="center">
        <b>🔔 Live Connection Notifications</b>
        <br/>
        <img src="src/assets/Github-Images/User-LiveNotification.png" width="100%" alt="LuminaVibe Notifications"/>
      </td>
    </tr>
  </table>
</div>
